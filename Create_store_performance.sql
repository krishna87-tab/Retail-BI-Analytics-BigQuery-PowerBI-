...
CREATE OR REPLACE VIEW `project-58590435-81ce-49e7-b27.retail_bi_mart.vw_store_performance` AS
SELECT
  store_id,
  store_name,
  store_type,
...
GROUP BY store_id, store_name, store_type, store_city, store_state, store_country;
